...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2024 at 07:48 PM
...
(1, 'lahiru', '071 245 4554', 'lahiru@gmail.com'),
(3, 'akila', '017 568 7584', 'akila@gmail.com');
...
(1, 1, '2024.06.23', '1500.000000'),
(2, 3, '2024.06.24', '2000.000000');
...
(1, 'lahiru', 'Big Boss Burger', 1250, 1),
(3, 'iresh', 'Veg Burger', 1550, 2);
...
(2, 'bumindu', 'pass', 'Admin'),
(3, 'lahiru', 'lahi', 'customer');
...
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11234;
